...
namespace WebShop.Tricentis.Tests.Scenarios
{
    ...
    public class ContactUsSteps
    {
        ...
        private readonly string _userName = "Андрей Гуляев";
        private readonly string _userEmail = "andrew-walker@yandex.ru";
        ...
        public void ThenDataInInputsIsCorrect()
        {
            Assert.AreEqual(_userName, _contactUs.GetName());
            Console.WriteLine("Expected " + _userName);
        ...
        public void ThenEmailInInputsIsCorrect()
        {
            Assert.AreEqual(_userEmail, _contactUs.GetEmail());
            Console.WriteLine("Expected " + _userEmail);
